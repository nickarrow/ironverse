...
track name="[[The Starforged\/Campaign Jett Foley\/Progress\/Jett\/Find Sofia Legrand.md|Find Sofia Legrand]]" status="added"
```
...
actor name="[[The Starforged\/Campaign Jett Foley\/Characters\/Jett Foley\/Jett Foley.md|Jett Foley]]" {
    move "[Fulfill Your Vow](datasworn:move:starforged\/quest\/fulfill_your_vow)" {
        progress-roll name="[[The Starforged\/Campaign Jett Foley\/Progress\/Jett\/Find Sofia Legrand.md|Find Sofia Legrand]]" score=8 vs1=5 vs2=9
    }
}
```
