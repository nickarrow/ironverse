...
track name="[[The Starforged\/Campaign Jett Foley\/Progress\/Jett\/Find Sofia's missing ship.md|Find Sofia's missing ship]]" status="added"
```
...
```iron-vault-mechanics
actor name="[[The Starforged\/Campaign Jett Foley\/Characters\/Jett Foley\/Jett Foley.md|Jett Foley]]" {
...
actor name="[[The Starforged\/Campaign Jett Foley\/Characters\/Jett Foley\/Jett Foley.md|Jett Foley]]" {
    move "[Fulfill Your Vow](datasworn:move:starforged\/quest\/fulfill_your_vow)" {
        progress-roll name="[[The Starforged\/Campaign Jett Foley\/Progress\/Jett\/Find out who is following Shen.md|Find out who is following Shen]]" score=3 vs1=1 vs2=3
    }
}
```
