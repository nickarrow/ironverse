...
```iron-vault-mechanics
track name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Survive the Asteroid Storm.md|Survive the Asteroid Storm]]" status="added"
- "![[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Survive the Asteroid Storm.md|iv-embed]]"
...
progress from=0 name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Survive the Asteroid Storm.md|Survive the Asteroid Storm]]" rank="dangerous" steps=2
actor name="[[The Starforged\/Characters\/Tybalt-Yhen Serrato.md|Tybalt-Yhen Serrato]]" {
    move "[Gain Ground](datasworn:move:starforged\/combat\/gain_ground)" {
        roll "Iron" action=6 adds=0 stat=3 vs1=10 vs2=7
    }
}
progress from=16 name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Survive the Asteroid Storm.md|Survive the Asteroid Storm]]" rank="dangerous" steps=1
...
progress from=24 name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Survive the Asteroid Storm.md|Survive the Asteroid Storm]]" rank="dangerous" steps=1
actor name="[[The Starforged\/Characters\/Tybalt-Yhen Serrato.md|Tybalt-Yhen Serrato]]" {
    move "[Take Decisive Action](datasworn:move:starforged\/combat\/take_decisive_action)" {
        progress-roll name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Survive the Asteroid Storm.md|Survive the Asteroid Storm]]" score=8 vs1=6 vs2=7
        meter "Momentum" from=2 to=3
    }
...
progress from=6 name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Find where he stands with Epathus.md|Find where he stands with Epathus]]" rank="extreme" steps=1
...
progress from=4 name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Reach the Devil's Chain Sector.md|Reach the Devil's Chain Sector]]" rank="formidable" steps=1
...
progress from=8 name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Reach the Devil's Chain Sector.md|Reach the Devil's Chain Sector]]" rank="formidable" steps=2
...
```
```iron-vault-mechanics
progress from=8 name="[[The Starforged\/Progress\/Tybalt-Yhen Serrato\/Find where he stands with Epathus.md|Find where he stands with Epathus]]" rank="extreme" steps=1
actor name="[[The Starforged\/Characters\/Tybalt-Yhen Serrato.md|Tybalt-Yhen Serrato]]" {
