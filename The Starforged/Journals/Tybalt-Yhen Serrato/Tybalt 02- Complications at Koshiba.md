...
`iv-move:Face Danger (Scene Challenge)|Wits|2|2|0|3|4|move:starforged/scene_challenge/face_danger`  `iv-track-advance:Complaint Compiling|The Starforged/Progress/Tybalt-Yhen Serrato/Complaint Compiling.md|16|24|dangerous|1`  `iv-clock-advance:Meet & Greet concluded|The Starforged/Clocks/Tybalt-Yhen Serrato/Meet & Greet concluded.md|2|3|1|4`  `iv-move:Face Danger (Scene Challenge)|Wits|3|2|0|8|9|move:starforged/scene_challenge/face_danger`  `iv-clock-advance:Meet & Greet concluded|The Starforged/Clocks/Tybalt-Yhen Serrato/Meet & Greet concluded.md|3|4|1|4`  `iv-clock-resolve:Meet & Greet concluded|The Starforged/Clocks/Tybalt-Yhen Serrato/Meet & Greet concluded.md`  `iv-progress:Finish the Scene|Complaint Compiling|6|10|9|The Starforged/Progress/Tybalt-Yhen Serrato/Complaint Compiling.md|move:starforged/scene_challenge/finish_the_scene`  `iv-oracle:Pay the Price|47|A new enemy is revealed|move.oracle_rollable:starforged/fate/pay_the_price.pay_the_price` 
