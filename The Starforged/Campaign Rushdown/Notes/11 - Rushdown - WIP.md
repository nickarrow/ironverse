...
*Rushdown is on his way back to [[Minami City]] with information he recovered from the Miwako, an arkship in an [[Ascendancy of the Awakened Worlds]] ship graveyard.  On the way, he was ambushed by the [[Resistance]], and managed to capture [[The Spider]].*

`iv-oracle:Likely|90|No|move.oracle_rollable:starforged/fate/ask_the_oracle.likely` 

`iv-oracle:Begin a Session|84|Peril lies ahead or lurks just out of view|move.oracle_rollable:starforged/session/begin_a_session.begin_a_session` 

"What's the latest on the situation in Ashitaba?"

"No news since our ship got blown up."

"What?  Our ship got blown up and nobody told me?"

"I sent you a report."

"I must have missed it.  Did we send a replacement squad?"

"I was waiting for you to order one."

"Damn it.  Well, I'm ordering one now."

"Covert, same as before?"

"Yes, we'll send in a covert team to scout out the situation.  But have a strike team on standby, I don't know who [[Minami Clan|Minami]] have that are able to find and eliminate a [[Satonaka Clan|Satonaka]] deep cover unit, but when I find out there'll be hell to pay."

`iv-clock-create:10 - Satonaka Return|The Starforged/Campaign Rushdown/Clocks/10 - Satonaka Return.md`  `iv-meter:Momentum|5|6` 
...
"Pyla, Devil's Chain sector.  It's a pirate clan's ship graveyard."
...
"We found out the password for the *Minami*.  You can finally unlock access to the ship's systems and end the cycle of cloning Captain Finn."

"Who else knows the password?"

"Only Rushdown here and his away team.  Don't worry, it still needs your biometric readings to work, nobody else can use it."

`iv-progress:Fulfill Your Vow|06 - Find the fate of the Miwako and recover any surviving intel|8|10|8|The Starforged/Campaign Rushdown/Progress/Vows/06 - Find the fate of the Miwako and recover any surviving intel.md|move:starforged/quest/fulfill_your_vow`  `iv-track-complete:06 - Find the fate of the Miwako and recover any surviving intel|The Starforged/Campaign Rushdown/Progress/Vows/06 - Find the fate of the Miwako and recover any surviving intel.md` 

"Well, that's not strictly true, if the board were to find out the password then any of the clones could use it to give them full power over Minami.  They wouldn't need us clones any more.  You were thorough.  Too thorough.  Guards!"  Two guards enter the room, weapons raised.  "Arrest these two, and lock them up.  Send a squad to the *Seventh Son*, we need the away team from the Miwako as well."

Rushdown looks at Gray.

>Does she want to make a break for it?  `iv-oracle:50/50|56|No|move.oracle_rollable:starforged/fate/ask_the_oracle.fifty_fifty` 

She shakes her head.  Rushdown puts his hands up and complies with the guards.  They are taken to a holding cell in the underbelly of the *Minami*.

>Is the Spider in the holding cell?  `iv-oracle:50/50|22|Yes|move.oracle_rollable:starforged/fate/ask_the_oracle.fifty_fifty` 

There are all sorts of criminals in the holding cell, all waiting for processing, but Rushdown sees one face he recognizes - the Spider.  He sees Rushdown and waves him over.  "So, what are you in for?"

"They sent us to find info, but they don't trust us with the info."

"I'd be very interested to hear what you found."

"You very definitely would."
...
"Do you want the long version or the short version?" says a large man wearing a suit.  He has a cigar in his hand.

"Let's start with the short version and we'll ask questions if necessary," says Gray.

"You have the password, we want it."

"Is there some kind of medium version?" asks Rushdown.
...
"And you'd send work our way every once in a while?"

`iv-move:Make a Connection|Heart|3|2|0|2|6|move:starforged/connection/make_a_connection`  `iv-track-create:Connection The Board|The Starforged/Campaign Rushdown/Progress/Connections/Connection The Board.md` 

"We were kind of hoping you'd give us an exclusive contract, but we're not ready to talk about that until we're in control."

"Yeah, that's something I'd have to talk to HQ about," says Gray quickly.

"Exactly," says the man in the suit, "Not the time."

"Ok then," says Rushdown, "The code is the original Captain Finn's mother's maiden name followed by his date of birth."

"That's it?  You can't be serious," says the man in the suit.  "All these years and we probably could have just guessed it."

"The apples didn't fall too far from the tree, I guess."
