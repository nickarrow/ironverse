...
```iron-vault-mechanics<br>oracle-group name="Planet: [[Rosston]]" {<br>    oracle name="[Templates \/ Region](datasworn:oracle_rollable:starforgedsupp\/core\/region)" result="Terminus" roll=15<br>    oracle name="[Planet Oracles \/ Planetary Class](datasworn:oracle_rollable:starforged\/planet\/class)" result="[Ice World](datasworn:oracle_collection:starforged\/planet\/ice)" roll=44<br>    oracle name="[Planet Oracles \/ Ice World \/ Atmosphere](datasworn:oracle_rollable:starforged\/planet\/ice\/atmosphere)" result="Breathable" roll=92<br>    oracle name="[Planet Oracles \/ Ice World \/ Observed From Space](datasworn:oracle_rollable:starforged\/planet\/ice\/observed_from_space)" result="Frozen oceans" roll=24<br>    oracle name="[Planet Oracles \/ Ice World \/ Observed From Space](datasworn:oracle_rollable:starforged\/planet\/ice\/observed_from_space)" result="Snowbound mountains" roll=71<br>    oracle name="[Settlements](datasworn:oracle_rollable:starforged\/planet\/ice\/settlements\/terminus)" result="Planetside settlement" roll=70<br>}```
