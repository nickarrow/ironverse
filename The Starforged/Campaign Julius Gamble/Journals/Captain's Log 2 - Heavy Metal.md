...
`iv-oracle:Location|89|Deep Space|oracle_rollable:starforged/derelict/location`  `iv-oracle:Spaceborne Opportunity|31|Derelict ripe for the picking|oracle_rollable:starforged/space/opportunity` 
 `iv-oracle:Starship Type|40|Mender|oracle_rollable:starforged/starship/type` `iv-oracle:First Look|10|Bristling with weapons|oracle_rollable:starforged/starship/first_look` 
