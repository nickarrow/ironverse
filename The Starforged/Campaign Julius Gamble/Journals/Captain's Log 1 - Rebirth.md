...
`iv-track-create:Become A Legend|The Starforged/Campaign Julius Gamble/Progress/Become A Legend.md` 
...
`iv-noroll:Pay the Price|move:starforged/fate/pay_the_price`  `iv-clock-advance:Underworld Retribution|The Starforged/Campaign Julius Gamble/Clocks/Underworld Retribution.md|0|1|1|6` 
...
`iv-oracle:Likely|36|Yes|move.oracle_rollable:starforged/fate/ask_the_oracle.likely` 
...
`iv-oracle:Planetary Class|88|Rocky World|oracle_rollable:starforged/planet/class`  `iv-oracle:Outlands|80|Orbital settlement|oracle_rollable:starforged/planet/rocky/settlements/outlands` 
