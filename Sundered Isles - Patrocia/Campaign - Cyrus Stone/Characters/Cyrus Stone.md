...
assets:
  - id: asset:sundered_isles/path/swashbuckler
    ...
    controls: {}
    options: {}
  - id: asset:sundered_isles/path/duelist
    abilities:
      - true
      - false
      - false
